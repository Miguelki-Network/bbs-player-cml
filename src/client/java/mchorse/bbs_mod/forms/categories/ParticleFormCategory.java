...
{
    public ParticleFormCategory(IKey title, ValueBoolean visibility)
    {
    ...
    {
        return new UIParticleFormCategory(this, list);
    }

    public static class Folder extends ParticleFormCategory
    {
