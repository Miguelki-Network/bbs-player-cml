...
public class OBJParser
{
    ...
    public void setupTextures(String key, File folder)
    {
        ...
        for (OBJMaterial material : this.materials.values())
        {
            ...
            {
                material.texture = Link.assets(key + "/skins/" + material.name + "/default.png");
    ...
    public void readMTL() throws Exception
    {
        ...
        for (String line : lines)
        {
            ...
            {
                String texture = String.join(" ", dropFirstArgument(tokens));

                material.texture = Link.create(texture);
            }
        }
    }
     ...
     */
    public Map<String, MeshesOBJ> compile()
    {
        Map<String, MeshesOBJ> meshes = new HashMap<>();
